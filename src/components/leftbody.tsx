...
export default function LeftBody() {
	return (
		<div className='h-full bg-[#D3E3A3] rounded-[25px] text-black flex flex-col justify-between'>
			<div className='flex flex-row gap-2 px-10 py-4 items-center italic'>
				<div className='flex flex-row'>
					<div className='rounded-full w-10 h-10 bg-slate-400  border-4 border-[#D3E3A3]'></div>
					<div className='rounded-full w-10 h-10 bg-slate-400 ml-[-10px] border-4 border-[#D3E3A3]'></div>
					<div className='rounded-full w-10 h-10 bg-slate-400 ml-[-10px] border-4 border-[#D3E3A3]'></div>
				</div>
				<div className='text-xs'>
					156,081 people already invest their money. <br />
					Join them!
				</div>
			</div>
			<div className='px-10'>
				...
				<div className='mt-3 px-4 bg-gradient-to-t from-gray-600 to-gray-800 rounded-[20px] py-4 shadow-lg  text-white w-40 cursor-pointer'>
					<p className='text-sm text-center'>Create my wallet</p>
				</div>

				<div className='flex gap-2 w-3/4 justify-between opacity-40 p-3 mt-3'>
					<div className='w-4'>
